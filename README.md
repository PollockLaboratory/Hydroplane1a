...
Go code based from https://github.com/PollockLaboratory/AnCovMulti

## References
Hydroplane I: one-shot probabilistic evolutionary analysis for scalable organizational identification
Connah G. M. Johnson $^1$, {}, David D. Pollock $^2$ $^3$ $^*$  $^{2, 3*}$

$^1$ Physical and Computational Sciences Directorate, Pacific Northwest National Laboratory, Richland, Washington, 99352, United States of America
...
David D. Pollock, david.pollock@cuanschutz.edu
